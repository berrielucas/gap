...
<template>
  <v-app :theme="theme" v-if="store.auth">
    ...
    <v-app-bar height="60"
      ...
      <v-btn class="mr-4 ml-auto" icon="mdi-bell-ring-outline" variant="text" size="35"
      ...
      <v-menu transition="scale-transition" location="bottom center" v-model="menu">
        <template v-slot:activator="{ props }">
          <v-chip class="mr-3" :class="menu ? 'menu-active' : 'menu-deactive'" v-bind="props"
            style="transition: all .2s cubic-bezier(0.165, 0.84, 0.44, 1); border: solid 1px #a5a5a5;">
