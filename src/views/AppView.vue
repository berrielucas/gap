    ...
    >
      ...
      <v-menu transition="scale-transition" location="bottom center" v-model="menu" >
        <template v-slot:activator="{ props }">
          <v-list-item class="mr-3 ml-auto" :class="menu?'menu-active':'menu-deactive'" v-bind="props" style="border-radius: 30px !important; transition: all .2s cubic-bezier(0.165, 0.84, 0.44, 1); border: solid 1px #a5a5a5;">
        ...
        <v-list style="margin: 1rem 0; width: 290px; padding: 0; background: linear-gradient(45deg, rgba(0,34,55,1) 0%, rgba(1,12,24,1) 50%, rgba(0,34,55,1) 100%); color: var(--text-color-light); border-radius: 20px;">
